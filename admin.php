...
if(!$user->isLoggedIn()) {
	...
	if($user->isSuperAdmin()) {
		...
		switch ( $action ) {
			...
			break;
			case 'listMagazines':	
				require('admin/listMagazines.php');
			break;
			case 'listJournals':	
				require('admin/listJournals.php');
			break;
			case 'editJournal':	
				require('admin/editJournals.php');
			break;
			case 'editMagazine':	
				require('admin/editMagazine.php');
			break;
			case 'editBooks':	
			...
			break;
			case 'SlistResearch':
				require('admin/SlistResearch.php');
			break;
			case 'Sborrowed':
				require('admin/Sborrowed.php');
			break;
			case 'Sreturned':
				require('admin/Sreturned.php');
			break;
			case 'editResearch':	
			...
			break;
			case 'SlistMagazines':
				require('admin/SlistMagazines.php');
			break;
