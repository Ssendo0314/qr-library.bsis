            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Library Management System - Return Books</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title"><i class="fa fa-book"></i>  Return Books</h3>                           
                                </div><!-- /.box-header -->
                                <div class="box-body">
									<div class="row">
											...
											<div class="row">
												...
												<div class="col-xs-7">
													...
													<div class="row">
														...
														<div class="col-xs-9">
															<div class="form-group">
																<input type="text" class="form-control" id="borrowerID" name="borrowerID" readonly>
															</div>
														</div>
													</div>
													<div class="row">
													...
													<div class="row">
														...
														<div class="col-xs-9">
															<div class="form-group">
																<input type="text" maxlength="11" class="form-control" id="borrowerContact" name="borrowerContact" readonly />
															</div>
														</div>
													</div>
													<div class="row">
														...
														<div class="col-xs-9">
															<div class="form-group">
																<input type="text" class="form-control" id="dateBorrowed" name="dateBorrowed" readonly>
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-xs-12">
															...
															<button type="submit" class="btn btn-warning btn-lg btn-huge" style="display:none;" name="transact" id="transact">RETURN BOOK</button>
		...
		var isbn = content;
			$.ajax({
				...
				success : function(data){
					...
					$("#borrowerContact").val(data.borrowerContact);
