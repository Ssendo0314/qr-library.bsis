        ...
        <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="admin.php?action=listMagazines"><i class="fa fa-angle-double-right"></i> Manage Magazines</a></li>
                            <li><a href="admin.php?action=listJournals"><i class="fa fa-angle-double-right"></i> Manage Journals</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="admin.php?action=listResearch">
                            <i class="fa fa-search"></i> <span>Researches</span>
                        </a>
                    </li>
                </ul>
            <?php } ?>
            ...
            <?php if ($user->isElAdmin()) { ?>
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="#">
                            <i class="fa fa-home"></i> <span>(On Progress)</span>
                        </a>
                    </li>
                </ul>
            <?php } ?>
            <?php if ($user->isTeacher()) { ?>
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="admin.php?action=Sbooklist"><i class="fa fa-angle-double-right"></i> Book List</a></li>
                            <li><a href="admin.php?action=Sborrowed"><i class="fa fa-angle-double-right"></i> Borrowed Books</a></li>
                            <li><a href="admin.php?action=Sreturned"><i class="fa fa-angle-double-right"></i> Return Books</a></li>
                        </ul>
                    </li>
                    <li class="active">
                        <a href="admin.php?action=Sjournals">
                            <i class="fa fa-archive"></i> <span>Journals</span>
                        </a>
                    </li>
                    <li class="active">
                        <a href="admin.php?action=SlistMagazines">
                            <i class="fa fa-archive"></i> <span>Magazines</span>
                        </a>
                    </li>
                    <li class="active">
                        <a href="admin.php?action=SlistResearch">
                            <i class="fa fa-archive"></i> <span>Researches</span>
                        </a>
                    </li>
                </ul>
            <?php } ?>
