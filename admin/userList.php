								...
								<div class="box-footer">
									...
									<div class="modal-dialog" role="document">
										...
										<div class="modal-body">
											...
											<label class="control-label" for="id"><font color="#EC0003">*</font> ID</label> 
												<div class="form-group">
													<input type="text" class="form-control" id="id" name="id" placeholder="Input id" required>
													<span id="userAvailable"></span>
												</div>
												<label class="control-label" for="email"><font color="#EC0003">*</font> Email</label> 
												<div class="form-group">
