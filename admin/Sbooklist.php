											...
											<?php
												...
												foreach($books->results() as $books){ ?>
														<tr>
															...
															<td align="center">
															<button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal_<?php echo ucwords($books->id); ?>" <?php echo ($books->is_borrowed == 1) ? 'disabled' : ''; ?>>View QRCODE</button>
																<!-- Modal -->
