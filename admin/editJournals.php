...
if (Input::exists()) {
            ...
            try {
                $journal->update(array(
					'journalTitle' => Input::get('bookTitle'),
					'author' => Input::get('author'),
					'datePublished' => Input::get('datePublished'),
                ), $_GET['id']);
			
			Session::flash('Updated', 'Journal Info has been successfully updated.');
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Journal Information</li>
                    </ol>
                </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Edit Journal - <small><font color="#EC0003">*</font> required fields</small></h3>    
                            ...
                            <div class="box-body">
								<?php if(Session::exists('journalUpdated')){ ?>
									<div class="alert alert-success">
										<i class="glyphicon glyphicon-ok"></i> &nbsp;<?php echo Session::flash('journalUpdated'); ?>
                                    </div>
								<?php }?>
                                <?php 
									$journals = DB:: getInstance()->get('journals', array('id','=',$_GET['id']));							
								...
								<form id="editUser" action="" method="post">
											...
											<div class="form-group">
												<div class="row">
													<div class="col-lg-8 col-md-8">
														<input type="text" class="form-control" id="isbn" name="isbn" value="<?php echo $journals->isbn; ?>" disabled>
													</div>
                                    ...
                                    <div class="row">
										<div class="col-lg-6 col-md-6">
											<label class="control-label" for="bookTitle"><font color="#EC0003">*</font> Journal Title</label>
											<div class="form-group">
												<input type="text" class="form-control" id="bookTitle" name="bookTitle" value="<?php echo $journals->journalTitle; ?>" >
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-3 col-md-3">
											...
											<div class="form-group">
												<input type="text" class="form-control" id="author" name="author" value="<?php echo $journals->author; ?>" required>
											</div>
										</div>
										<div class="col-lg-3 col-md-3">
											<label class="control-label" for="datePublished"><font color="#EC0003">*</font> Date of the Publication</label>
											<div class="form-group">
												<input type="text" class="form-control" id="datePublished" name="datePublished" value="<?php echo $journals->datePublished; ?>" data-provide="datepicker" required>
											</div>
										</div>
									</div>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="button" class="btn btn" onclick="window.location='admin.php?action=listJournals'">Cancel</button>
                                    </div>
                                    <br />
                                </form>
								<!-- Modal -->
													...
													<div class="modal-dialog modal-lg" role="document">
														...
														<div class="modal-body">
															<form enctype="multipart/form-data" method="post" action="editJournalQR.php">
																<label class="control-label" for="newIsbn"><font color="#EC0003">*</font> International Stardand Book Number</label>
																<div class="form-group">
																	<input type="text" class="form-control" id="newIsbn" name="newIsbn" value="<?php echo $journals->isbn; ?>">													
																</div>
																<input type="hidden" name="newID" value="<?php echo $journals->id; ?>">
														</div>
